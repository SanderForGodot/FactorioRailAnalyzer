...
data class Entity(
    ...
    @SerializedName("edgecase") var edgecase: Boolean = false  //this is set to true when the Entity can have Edgecases in the block creation, so that more prework needs to be done
