...
val fact: Map<String, Map<Int, List<Entity>>> = mapOf(
    "straight-rail" to mapOf(
        0 to listOf(
            ...
            Entity(-1, "signal", Position(-1.5, -1.5), 0),
            Entity(-1, "signal", Position(-1.5, -0.5), 0),
            Entity(1, "signal", Position(1.5, 0.5), 4),
            Entity(1, "signal", Position(1.5, 1.5), 4),
        ),
        2 to listOf(
            ...
            Entity(-1, "signal", Position(1.5, -1.5), 2),
            Entity(-1, "signal", Position(0.5, -1.5), 2),
            Entity(1, "signal", Position(-0.5, 1.5), 6),
            Entity(1, "signal", Position(-1.5, 1.5), 6),
        ),
        1 to listOf(
            ...
            Entity(-1, "signal", Position(1.5, -1.5), 3),
            Entity(1, "signal", Position(2.5, -0.5), 3),
        ),
        5 to listOf(
            ...
            Entity(-1, "signal", Position(-2.5, 0.5), 7),
        ...
        3 to listOf(
            ...
            Entity(-1, "signal", Position(0.5, 2.5), 5),
        ...
        7 to listOf(
            ...
            Entity(1, "signal", Position(-0.5, -2.5), 1),
        ),
    ),
    "curved-rail" to mapOf(
        0 to listOf(
            ...
            Entity(-1, "signal", Position(-3.5, -2.5), 7),
            Entity(1, "signal", Position(-2.5, -1.5), 7),
            Entity(1, "signal", Position(2.5, 3.5), 4),
            Entity(-1, "signal", Position(2.5, 4.5), 4),
        ), 1 to listOf(
            ...
            Entity(-1, "signal", Position(1.5, -4.5), 1),
            Entity(-1, "signal", Position(0.5, -3.5), 1,true),
            Entity(1, "signal", Position(2.5, -1.5), 5,true),
            Entity(-1, "signal", Position(0.5, 4.5), 4),
            ...
            Entity(-1, "signal", Position(-4.5, 2.5), 6),
            Entity(1, "signal", Position(-3.5, 2.5), 6),
            Entity(-1, "signal", Position(1.5, -2.5), 1),
            Entity(1, "signal", Position(2.5, -3.5), 1),
        ), 3 to listOf(
            ...
            Entity(-1, "signal", Position(-4.5, 0.5), 6),
            Entity(1, "signal", Position(-3.5, 0.5), 6),
            Entity(1, "signal", Position(1.5, 2.5), 7,true),
            Entity(-1, "signal", Position(4.5, 1.5), 3),
            Entity(-1, "signal", Position(3.5, 0.5), 3,true),
        ), 4 to listOf(
            ...
            Entity(1, "signal", Position(-2.5, -4.5), 0),
            ...
            Entity(-1, "signal", Position(-0.5, -4.5), 0),
            Entity(1, "signal", Position(-0.5, -3.5), 0),
            Entity(-1, "signal", Position(-2.5, 1.5), 1,true),
            Entity(1, "signal", Position(-1.5, 4.5), 5),
            Entity(1, "signal", Position(-0.5, 3.5), 5,true),
        ), 6 to listOf(
            Entity(1, "straight-rail", Position(5.0, -1.0), 2),
            ...
            Entity(1, "signal", Position(4.5, -2.5), 2),
            Entity(-1, "signal", Position(3.5, -2.5), 2),
            Entity(-1, "signal", Position(-2.5, 3.5), 5),
            ...
            Entity(1, "signal", Position(-4.5, -1.5), 7),
            Entity(1, "signal", Position(-3.5, -0.5), 7,true),
            Entity(-1, "signal", Position(3.5, -0.5), 2),
            Entity(1, "signal", Position(4.5, -0.5), 2),
        )
    )
)
